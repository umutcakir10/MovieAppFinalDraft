...
namespace Moviegram.Controllers
{
    public class MoviesController : Controller
    {
        ...
        private readonly IMoviePostQuoteRepository moviePostQuoteRepository;
        ...
        public MoviesController(IMoviePostRepository moviePostRepository,
            ...
            IMoviePostQuoteRepository moviePostQuoteRepository)
        {
        ...
        public async Task<IActionResult> Index(MovieDetailsViewModel movieDetailsViewModel)
        {
            ...
            //if (signInManager.IsSignedIn(User))
            //{
            //    var domainModel = new MoviePostQuote
            //    {
            //        MoviePostId = movieDetailsViewModel.Id,
            //        Description = movieDetailsViewModel.QuoteDescription,
            //        UserId = Guid.Parse(userManager.GetUserId(User)),
            //        DateAdded = DateTime.Now
            //    };
            //    await moviePostQuoteRepository.AddAsync(domainModel);
            //    return RedirectToAction("Index", "Home",
            //        new { urlHandle = movieDetailsViewModel.UrlHandle });
            //}
            //return View();
